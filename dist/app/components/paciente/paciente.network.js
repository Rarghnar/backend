...
router.get("/all", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield paciente_controller_1.default.getPacientes();
...
router.get("/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield paciente_controller_1.default.getPacienteById(id);
            response_module_1.default.success(req, res, result);
        }
        catch (error) {
            console.log(error);
...
router.post("/add", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const body = req.body;
        try {
            const result = yield paciente_controller_1.default.addPaciente(body);
...
router.delete("/delete", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const ver = yield paciente_controller_1.default.deletePaciente(req.body._id);
            if (ver != null) {
...
router.patch("/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const modPaciente = yield paciente_controller_1.default.modPaciente(id, req.body);
